 ...
 * Version: 3.0.0 (Production Ready - Premium Edition)
 * 
 * Features:
...
class MultiEditor {
    ...
    constructor(selector, config = {}) {
        ...
        if (this.cfg.autoSave) {
            ...
            if (saved) {
                ...
                if (saved.widgets) this.cfg.allowTool = saved.widgets;
                ...
                <header class="me-toolbar">
                    ...
                    <div class="me-toolbar-right">
                        <div class="me-select" id="me-lang-sel">
                            <div class="me-select-trigger">🌐 ${this.cfg.lang.toUpperCase()}</div>
                            <div class="me-select-menu"></div>
                        </div>
                        <div class="me-select" id="me-theme-sel">
                            <div class="me-select-trigger">🎨 ${this._capitalize(this.cfg.defaultStyle)}</div>
                            <div class="me-select-menu"></div>
                        </div>
                        ${this.cfg.enableFullscreen ? `<button class="me-btn icon-only" id="me-fullscreen" title="Fullscreen">⛶</button>` : ''}
                        <button class="me-btn" id="me-export" title="${this.t.export}">📤</button>
                        <button class="me-btn" id="me-import" title="${this.t.import}">📥</button>
                        <input type="file" id="me-import-file" accept=".json" style="display:none;">
                        <button class="me-btn primary" id="me-save-main">💾 ${this.t.save}</button>
                    </div>
                </header>
    ...
    _initCustomSelect() {
        ...
        this.themes.forEach(t => {
            ...
            opt.onclick = () => {
                this.setTheme(t);
                themeTrigger.innerText = `🎨 ${this._capitalize(t)}`;
        ...
        languages.forEach(lang => {
            ...
            opt.onclick = () => {
                ...
                langTrigger.innerText = `🌐 ${lang.code.toUpperCase()}`;
        ...
        this.currentWidgets.forEach((id, index) => {
            ...
            w.innerHTML = `
                <div class="me-widget-h">
                    <span>${this._escapeHtml(this.t[id] || id)}</span>
                    <div class="me-widget-h-actions">
                        <button class="me-widget-h-btn" data-action="close" title="Close">×</button>
                    </div>
                </div>
            ...
            <div class="me-cal-wrap">
                <div class="me-cal-header">
                    <div class="me-cal-nav">
                        <button class="me-cal-nav-btn" data-action="prev-year">«</button>
                        <button class="me-cal-nav-btn" data-action="prev-month">‹</button>
                    </div>
                    <div class="me-cal-title">${year} ${this.t.months[month]}</div>
                    <div class="me-cal-nav">
                        <button class="me-cal-nav-btn" data-action="next-month">›</button>
                        <button class="me-cal-nav-btn" data-action="next-year">»</button>
                    </div>
                </div>
        ...
        const draw = () => {
            ...
            list.innerHTML = this.cfg.data.reminders.map((item, i) => `
                <div class="me-todo-item ${item.completed ? 'completed' : ''}" data-index="${i}">
                    ...
                    <button class="me-todo-delete" data-action="delete" title="${this.t.delete}">×</button>
                </div>
            `).join('');
        ...
        con.innerHTML = `
            <div class="me-calc-container">
                ...
                <div class="me-calc-grid">
                    ...
                    <button class="me-calc-btn" data-action="backspace">⌫</button>
            ...
            <div class="me-md-container">
                <div class="me-md-editor">
                    <div class="me-md-toolbar">
                        <button class="me-md-btn" data-md="bold" title="Bold">B</button>
                        <button class="me-md-btn" data-md="italic" title="Italic"><i>I</i></button>
                        <button class="me-md-btn" data-md="h1" title="Heading 1">H1</button>
                        <button class="me-md-btn" data-md="h2" title="Heading 2">H2</button>
                        <button class="me-md-btn" data-md="h3" title="Heading 3">H3</button>
                        <button class="me-md-btn" data-md="link" title="Link">🔗</button>
                        <button class="me-md-btn" data-md="code" title="Code">&lt;&gt;</button>
                        <button class="me-md-btn" data-md="ul" title="List">•</button>
                        <button class="me-md-btn" data-md="quote" title="Quote">"</button>
                    </div>
